...
Dispatch loom:code-reviewer subagent to catch issues before they cascade.
...
Use Task tool with loom:code-reviewer type, fill template at `code-reviewer.md`
...
- **Trigger:** after a review is requested or completed
- **Reserved key(s):** `note`
- **Entry shape:**
  ```
  ## <ISO8601-timestamp> — requesting-code-review
  note: review requested; reviewer = <name>
